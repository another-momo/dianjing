...
const zhCN = {
  ...
  agentCapabilities: {
    ...
    installedSkillsDeleteLabel: '删除{name}',
    installedSkillsDeleteAction: '删除',
    installedSkillsDeleteConfirmTitle: '确认删除该技能？',
    installedSkillsDeleteConfirmDescription: '将{name}及其目录内全部文件从磁盘删除，无法恢复。',
    installedSkillsDeleteConfirmAction: '从磁盘删除',
