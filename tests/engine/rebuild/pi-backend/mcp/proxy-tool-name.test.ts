...
import { proxyToolName } from '@/app/ai/pi-backend/mcp/proxy-tool-name'
...
describe('proxyToolName (#864)', () => {
  ...
  it('sanitizes dots that OpenAI/Codex reject', () => {
    ...
    expect(proxyToolName('dingtalk-docs', 'pat.batch_grant')).toBe(
      'mcp__dingtalk-docs__pat_batch_grant'
    )
  })
